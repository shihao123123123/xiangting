...
import sys
sys.path.append('../API_B')
from  API_B import API_System, API_FILE, API_PyQt5, API_Math, API_Radiation
...
class SpectrumMeter(QMainWindow):    
    def __init__(self):        
        ...
        # self.toolButton.setToolTip("开始")
        #
        # self.toolButton_2.setStyleSheet("border-image: url(:/icon/Icon/Stop.jpg);")
        # self.toolButton_2.setToolTip("停止")
        #
        # # self.toolButton_3.setStyleSheet("border-image: url(:/icon/Icon/server.jpg);")
        # self.toolButton.setToolTip("server")
        #
        # # self.toolButton_5.setStyleSheet("border-image: url(:/icon/Icon/clear.png);")
        # self.toolButton_5.setToolTip("清除")

        # self.toolButton_8.setStyleSheet("border-image: url(:/icon/Icon/grayChange.png);")
        # self.toolButton_8.setToolTip("grayChange")
        # icon8 = QtGui.QIcon()
        # icon8.addPixmap(QtGui.QPixmap(":/icon/Icon/grayChange.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        # self.toolButton_8.setIcon(icon8)
        # self.toolButton_8.setObjectName("toolButton_7")


        # self.toolButton_7.setStyleSheet("border-image: url(:/icon/Icon/Close.ico);")
        # self.toolButton_7.setToolTip("关闭")
        # icon7 = QtGui.QIcon()
        # icon7.addPixmap(QtGui.QPixmap(":/icon/Icon/Close.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        # self.toolButton_7.setIcon(icon7)
        # self.toolButton_7.setObjectName("toolButton_7")
        self.toolButton.setToolTip("开始")
        self.toolButton_2.setToolTip("停止")
        self.toolButton_3.setToolTip("server")
        self.toolButton_5.setToolTip("清除")
        self.toolButton_7.setToolTip("Close")
        self.toolButton_8.setToolTip("grayChange")
        # self.toolButton_9.setStyleSheet("border-image: url(:/icon/Icon/save.ico);")
        self.toolButton_9.setToolTip("保存")
        # self.toolButton_10.setStyleSheet("border-image: url(:/icon/Icon/solve.png);")

        # icon10 = QtGui.QIcon()
        # icon10.addPixmap(QtGui.QPixmap(":/icon/Icon/solve.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        # self.toolButton_10.setIcon(icon10)
        # self.toolButton_10.setObjectName("toolButton_10")
        self.toolButton_10.setToolTip("solve")
    ...
    def startCommunicationWithServer(self):
        ...
        self.UpdateTimeWorker = UpdateTime(self.label_23, self.label_14, self.label_16,self.label_11,self.label_20)
        ...
        if self.settingData["MCAType"] == "北京捷创核仪":
            for key in ["伽马谱"]:
                ...
                self.channelData[key] = np.zeros(1024);
