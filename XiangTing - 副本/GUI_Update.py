...
class UpdateTime(QThread):
    def __init__(self, timeLabel, dateSetting, timeSetting,label_11,label_20):
        super(UpdateTime, self).__init__()        
        self.timeLabel = timeLabel
        self.dateSetting = dateSetting
        self.timeSetting = timeSetting
        self.label_11=label_11
        self.label_20 = label_20
    def run(self):
        # debugpy.debug_this_thread()
        while True:
            self.sleep(1)
            ...
            self.label_11.setText(today + " "  + current_time)
            self.label_20.setText(today + " " + current_time)
